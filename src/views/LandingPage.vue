<template>
  ...
  <!-- Section News -->
  <section class="px-[120px] py-[100px]">
    <div class="flex justify-between items-center mb-[40px]">
      <h3 class="text-[32px] font-bold text-black">Apa yang terjadi di DIMSA</h3>
      <a href="#" class="text-blue-600 text-base font-normal hover:underline">Selengkapnya</a>
    </div>
  ...
  <section class="w-full sm:px-6 md:px-8 lg:px-[120px] py-[100px] bg-white">
    <div class="flex justify-between items-center mb-[40px]">
      <h3 class="text-[32px] font-bold text-black">Apa yang terjadi di DIMSA</h3>
      <a href="https://www.dimsa.sch.id/kabar"
        class="text-blue-600 text-base font-normal hover:underline">Selengkapnya</a>
    </div>
    ...
    <div class="flex md:flex-row gap-8">
      ...
      <div class="border border-gray-200 rounded-3xl p-[56px] flex flex-col justify-between h-full min-h-[376px]">
        ...
        <div class="flex flex-row items-center gap-4">
          ...
          <p class="text-gray-900 font-semibold">Fahmi Setiawan</p>
          <p class="text-gray-500 text-sm">Alumni 2018</p>
        </div>
      </div>
  ...
  <!-- CTA -->
  <section class="w-full bg-white lg:px-[120px] py-[100px]">
        ...
        <div class="relative bg-green-700 text-white rounded-xl p-6 overflow-hidden min-h-[300px]">
          ...
          <div class="absolute -left-44 top-[86px] flex gap-[23px]">
            ...
            <div class="bg-[#091E6F] text-white text-xs font-semibold py-5 px-4 rounded-[10px]">
              <img src="https://www.dimsa.sch.id/template3/image/buliding2.svg" class="w-[64px] h-[64px]" />
            </div>
          </div>
          ...
          <div class="absolute -right-44 top-[204px] flex flex-row-reverse gap-[23px]">
            <div
              ...
              <p class="text-center">SMP Darul Ihsan Muhammadiyah</p>
            </div>

            <div class="bg-white text-xs font-semibold py-5 px-4 rounded-[10px]">
              <img src="@/assets/icons/buildings.svg" class="w-[64px] h-[64px]" />
            </div>
          </div>

          <!-- Text -->
          <div class="flex flex-col justify-end h-full ml-[50px]">
            <p class="text-[32px] font-medium">Jadwal Penerimaan</p>
            <p class="text-[48px] font-bold">Santri Baru 2024</p>
          </div>
        </div>

        <!-- Ruang Literasi -->
        <div class="relative bg-neutral-100 rounded-xl p-6 overflow-hidden min-h-[500px]">
          <!-- Teks Judul -->
          <div class="flex flex-col justify-start h-full ml-[50px] mt-[56px]">
  ...
  <footer class="bg-[#080E1E] text-white pt-4">
    <div class="max-w-7xl mx-auto px-[72px]">
