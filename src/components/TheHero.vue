<template>
  <section
    class="relative min-h-screen pb-[80px] bg-center bg-cover bg-no-repeat text-white overflow-hidden">
    ...
    <div
      ...
      <div v-for="(slide, index) in slides" :key="index"
           class="min-w-full bg-center bg-cover flex flex-col justify-end pb-20 px-20"
           :style="{ backgroundImage: `url(http://127.0.0.1:8000/storage/${slide.image})` }">
           
        <!-- Headline -->
        <h1 class="text-[32px] md:text-[44px] font-bold md:font-semibold md:w-1/2 md:leading-snug leading-[120%] mb-16">
          {{ slide.headline }}
        </h1>
